...
public sealed class LocalizationServiceResourceTests
{
    ...
    public void ChangeDeviceDictionaries_ShareEquivalentLabels()
    {
        ...
        [
            ...
            ("ChangeSingleDevice_ColumnIndex", "ChangeMultipleDevices_ColumnIndex"),
            ...
            ("ChangeSingleDevice_ActionViewAllDeviceInfo", "ChangeMultipleDevices_ActionViewAllDeviceInfo"),
